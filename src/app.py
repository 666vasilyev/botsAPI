...
from src.admin.views import ArticleView, ChannelTestingView
    ...
    admin.add_view(
        DropDown(
            ...
            views=[
                ...
                ChannelTestingView(),
                # CustomView(label="Home", path="/home", template_path="src/admin/templates/hello.html")
            ],
        )
    )
    admin.add_view(
        DropDown(
            ...
            views=[
                ...
                Link(url="/bot/", label="Home Page"),
            ],
        )
    )
    admin.add_view(Link(label="Swagger API", url="/docs#"))
    admin.add_view(ArticleView(Bot))
